...
// Nutzerkorrektur 20.09.2026 ("keine bekannte sprache bei ayubbid dynsty,
// seljuk empire, sultanate of rum, byzantine und viele andere imperien ...
// jede imperium soll bekannte sprache angezeigt werden") — fuer sehr viele
// historische Dynastien/Sultanate hat Wikidata schlicht KEINE strukturierten
// Sprachdaten (P37/P2936/P103/P1412), obwohl die Sprache(n) historisch gut
// belegt sind (z.B. Byzanz -> Griechisch, Seldschuken -> Turksprachen +
// Persisch als Verwaltungssprache). Diese leichte, reine Sprach-Tabelle
// (ohne eigene Beschreibung — die kommt weiterhin von Wikipedia) deckt
// zusaetzlich die haeufig angeklickten "grossen Reiche" ab (Namen exakt aus
// dem Geodatenset extrahiert). Wird in route.ts VOR der Wikidata-Abfrage
// geprueft: schneller UND zuverlaessiger als eine Anfrage, die ohnehin oft
// leer zurueckkommt. Nur real dokumentierte Sprachen, keine Vermutungen ("
// unbekannt" wenn historisch tatsaechlich ungeklaert, z.B. Gutäer).
export const LANGUAGE_ONLY: Record<string, string> = {
  "Byzantine Empire": "Griechisch (ab dem 7. Jh.), zuvor Latein",
  "Great Seljuk Empire": "Oghusisch-Türkisch, Persisch (Verwaltung)",
  "Seljuk Dynasty": "Oghusisch-Türkisch, Persisch (Verwaltung)",
  "Sultanate of Rum": "Persisch (Hof), Turksprachen",
  "Ayyubid Sultanate": "Arabisch, Kurdisch",
  "Abbasid Caliphate": "Arabisch",
  "Abbasid Caliphate/Buyid Dynasty": "Arabisch, Persisch",
  "Adal Sultanate": "Somali, Arabisch, Harari",
  "Aghlabid Dynasty": "Arabisch",
  "Ahmadnagar Sultanate": "Persisch, Marathi",
  "Akkadian Empire": "Akkadisch",
  "Almohad Caliphate": "Arabisch, Berberisch",
  "Almoravid Dynasty": "Arabisch, Berberisch",
  "Angevin Empire": "Altfranzösisch, Mittelenglisch",
  "Antigonid Dynasty": "Griechisch (Koine)",
  "Ashanti Empire": "Twi (Akan)",
  "Ashikaga Shogunate": "Japanisch",
  "Astrakhan Khanate": "Tatarisch (Turksprache)",
  "Austrian Empire": "Deutsch",
  "Bahmani Sultanate": "Persisch",
  "Bahrani Dynasty": "Arabisch",
  "Bamana Empire": "Bambara",
  "Berar Sultanate": "Persisch",
  "Bidar Sultanate": "Persisch",
  "Bijapur Sultanate": "Persisch",
  "Blue Horde": "Kiptschakisch (Turksprache)",
  "Bornu Empire": "Kanuri",
  "British Colonial Empire": "Englisch",
  "British Empire": "Englisch",
  "(British Empire)": "Englisch",
  "Caliphate of Córdoba": "Arabisch",
  "Carnatic Sultanate": "Persisch, Urdu",
  "(Carolingian Empire)": "Latein (Schrift-/Kirchensprache), Altfränkisch",
  "Chalukya Dynasty": "Kannada, Sanskrit",
  "Chandra Dynasty": "Sanskrit, Bengalisch",
  "Chauhan Dynasty": "Sanskrit, Altrajasthani",
  "Chaulukya Dynasty": "Sanskrit, Altgujarati",
  "Chen Dynasty": "Mittelchinesisch",
  "Crimean Khanate": "Krimtatarisch (Turksprache)",
  "Dabuyid Dynasty": "Persisch (Tabaristan-Dialekte)",
  "Demak Sultanate": "Javanisch",
  "(Delhi Sultanate)": "Persisch (Hof), Hindavi",
  "Durrani Dynasty": "Paschtu, Persisch (Dari)",
  "Durrani Empire": "Paschtu, Persisch (Dari)",
  "Dzungar Khanate": "Oiratisch (Mongolisch)",
  "Early Lý Dynasty": "Vietnamesisch",
  "Eastern Chagatai Khanate": "Tschagataisch",
  "Empire of Brazil": "Portugiesisch",
  "Empire of China": "Mittelchinesisch",
  "Empire of Haiti": "Französisch, Haitianisches Kreol",
  "Empire of Japan": "Japanisch",
  "Empire of Kanem": "Kanuri",
  "Empire of Thessalonica": "Griechisch",
  "Empire of Trebizond": "Griechisch",
  "First French Empire": "Französisch",
  "(First French Empire)": "Französisch",
  "First French colonial empire": "Französisch",
  "First Mexican Empire": "Spanisch",
  "First Sealand Dynasty": "Akkadisch",
  "First Toungoo Empire": "Birmanisch",
  "Funj Sultanate": "Arabisch",
  "Gahadavala Dynasty": "Sanskrit",
  "Gallic Empire": "Latein",
  "German Empire": "Deutsch",
  "Ghaznavid Empire": "Persisch",
  "Golconda Sultanate": "Persisch, Telugu",
  "Gurjara-Pratihara Dynasty": "Sanskrit",
  "Gutian Dynasty": "unbekannt (kaum bezeugt)",
  "Hafsid Dynasty": "Arabisch, Berberisch",
  "Hammadid Dynasty": "Arabisch, Berberisch",
  "Harsha's Empire": "Sanskrit",
  "(Holy Roman Empire)": "Latein (Amtssprache), Deutsch",
  "Holy Roman Empire Minor States": "Deutsch, Latein",
  "Hotaki Dynasty": "Paschtu",
  "Hunnic Empire": "unklar, vermutlich hunnisch (schlecht bezeugt)",
  "Hussain Shahi Dynasty": "Persisch, Bengalisch",
  "Ifat Sultanate": "Arabisch, Harari, Somali",
  "Indo-Sasanian Empire": "Mittelpersisch",
  "Jalayirid Sultanate": "Mongolisch, Persisch",
  "Jaunpur Sultanate": "Persisch",
  "Kadamba Empire": "Kannada, Sanskrit",
  "Kakatiya Dynasty": "Telugu, Sanskrit",
  "Kalabhra Dynasty": "Tamil",
  "Kalmyk Khanate": "Oiratisch (Mongolisch)",
  "Kamakura Shogunate": "Japanisch",
  "Kannauj-Varman Dynasty": "Sanskrit",
  "Kanva Dynasty": "Sanskrit, Prakrit",
  "Karamanli Dynasty": "Arabisch, Osmanisch-Türkisch",
  "Karkota Dynasty": "Sanskrit",
  "Kashmiri Sultanate": "Persisch, Kaschmiri",
  "Kazakh Khanate": "Kasachisch",
  "Khadga Dynasty": "Sanskrit, Bengalisch",
  "Khalji Dynasty": "Persisch",
  "Khanate of Bukhara": "Usbekisch/Tschagataisch, Persisch",
  "Khanate of Kazan": "Tatarisch",
  "Khanate of Khiva": "Usbekisch/Tschagataisch, Turkmenisch",
  "Khanate of Kokand": "Usbekisch/Tschagataisch",
  "Khanate of Sibir": "Sibirtatarisch (Turksprache)",
  "Khanates of the Caucasus": "Turksprachen, Kaukasussprachen",
  "Khoshut Khanate": "Oiratisch (Mongolisch)",
  "Konbaung Dynasty": "Birmanisch",
  "Korean Empire": "Koreanisch",
  "Late Pallava Empire": "Tamil, Sanskrit",
  "Later Jin Dynasty": "Mandschurisch",
  "Later Liang Dynasty": "Mittelchinesisch",
  "Latin Empire": "Altfranzösisch",
  "Liang Dynasty": "Mittelchinesisch",
  "Liao Dynasty": "Khitanisch, Chinesisch",
  "Liu Song Dynasty": "Mittelchinesisch",
  "Lodi Dynasty": "Persisch (Hof), Paschtu",
  "Lohara Dynasty": "Sanskrit",
  "Lê Dynasty": "Vietnamesisch",
  "(Macedonian Empire)": "Griechisch (Altmakedonisch/Koine)",
  "Macedonian Empire": "Griechisch (Altmakedonisch/Koine)",
  "Magadha - Haryanka dynasty": "Sanskrit, Prakrit",
  "Magadha - Shaishunaga dynasty": "Sanskrit, Prakrit",
  "Mahameghavahana Dynasty": "Prakrit",
  "Maitraka Dynasty": "Sanskrit",
  "Majeerteen Sultanate": "Somali",
  "Marinid Sultanate": "Arabisch, Berberisch",
  "Massina Empire": "Fulfulde",
  "Mataram Sultanate": "Javanisch",
  "Maukhari Dynasty": "Sanskrit",
  "(Merovingian Empire)": "Altfränkisch, Latein",
  "Merovingian Empire": "Altfränkisch, Latein",
  "Mongol Empire": "Mongolisch",
  "Mongol Khanate": "Mongolisch",
  "Muhammad Ali dynasty": "Arabisch, Osmanisch-Türkisch",
  "Nabhani Dynasty": "Arabisch",
  "Najahid Dynasty": "Arabisch",
  "Nanda Empire": "Sanskrit, Prakrit",
  "Nguyễn dynasty": "Vietnamesisch",
  "Ngô Dynasty": "Vietnamesisch",
  "Nicaean Empire": "Griechisch",
  "Nogai Horde": "Nogaiisch (Turksprache)",
  "North Sea Empire": "Altenglisch, Altnordisch",
  "Oyo Empire": "Yoruba",
  "Pahang Sultanate": "Malaiisch",
  "Pala Empire": "Sanskrit, Bengalisch",
  "Palmyrene Empire": "Aramäisch, Griechisch",
  "Pandya Dynasty": "Tamil",
  "Pandya Empire": "Tamil",
  "Paramara Dynasty": "Sanskrit",
  "(Phoenician Empire)": "Phönizisch",
  "Pontianak Kadriyah Sultanate": "Malaiisch",
  "(Portuguese Empire)": "Portugiesisch",
  "Portuguese Empire": "Portugiesisch",
  "Qajar Dynasty": "Persisch",
  "Qasim Khanate": "Tatarisch",
  "Qin Dynasty": "Altchinesisch",
  "Rashtrakuta Dynasty": "Kannada, Sanskrit",
  "Rasulid Dynasty": "Arabisch",
  "Riau-Lingga Sultanate": "Malaiisch",
  "Russian Empire": "Russisch",
  "Rustamid dynasty": "Arabisch, Berberisch",
  "Saadi Sultanate": "Arabisch, Berberisch",
  "Saffarid Dynasty": "Persisch",
  "Sajid Dynasty": "Arabisch, Persisch",
  "Samanid Empire": "Persisch",
  "Samudera Pasai Sultanate": "Malaiisch",
  "Satavahana Dynasty": "Prakrit",
  "Sayyid Dynasty": "Persisch",
  "Second Bulgarian Empire": "Bulgarisch",
  "(Second French Empire)": "Französisch",
  "Second French Empire": "Französisch",
  "Second Mexican Empire": "Spanisch",
  "Sena Dynasty": "Sanskrit, Bengalisch",
  "Serbian Empire": "Serbisch",
  "Shang Dynasty": "Altchinesisch",
  "Shunga Empire": "Sanskrit",
  "Shunten Dynasty": "Ryukyuanisch, Japanisch",
  "Sikh Empire": "Punjabi",
  "Sind-Habbari Dynasty": "Arabisch, Sindhi",
  "Sind-Samma Dynasty": "Sindhi",
  "Small Horde": "Kasachisch",
  "Sokoto Caliphate": "Fulfulde, Hausa, Arabisch",
  "Sosso Empire": "Soninke/Mandinka",
  "(Spanish Empire)": "Spanisch",
  "Spanish Empire": "Spanisch",
  "Sulayhid Dynasty": "Arabisch",
  "Sultanate of Aceh": "Malaiisch",
  "Sultanate of Banjar": "Malaiisch, Banjaresisch",
  "Sultanate of Banten": "Sundanesisch, Javanisch",
  "Sultanate of Bengal": "Persisch (Hof), Bengalisch",
  "Sultanate of Bima": "Bima-Sprache, Malaiisch",
  "Sultanate of Bone": "Buginesisch",
  "Sultanate of Brunei": "Malaiisch",
  "Sultanate of Cirebon": "Javanisch, Sundanesisch",
  "Sultanate of Darfur": "Fur, Arabisch",
  "Sultanate of Gowa": "Makassarisch",
  "Sultanate of Harar": "Harari, Arabisch, Oromo",
  "Sultanate of Hobyo": "Somali",
  "Sultanate of Jambi": "Malaiisch",
  "Sultanate of Johor": "Malaiisch",
  "Sultanate of Kedah": "Malaiisch",
  "Sultanate of Kutai Kartanegara": "Malaiisch, Kutai",
  "Sultanate of Maguindanao": "Maguindanaon",
  "Sultanate of Malacca": "Malaiisch",
  "Sultanate of Mempawah": "Malaiisch",
  "Sultanate of Muscat and Oman": "Arabisch",
  "Sultanate of Oman": "Arabisch",
  "Sultanate of Palembang": "Malaiisch",
  "Sultanate of Perak": "Malaiisch",
  "Sultanate of Sambaliung": "Malaiisch",
  "Sultanate of Sambas": "Malaiisch",
  "Sultanate of Selangor": "Malaiisch",
  "Sultanate of Sukadana": "Malaiisch",
  "Sultanate of Sulu": "Tausug",
  "Sultanate of Terengganu": "Malaiisch",
  "Sultanate of Zanzibar": "Swahili, Arabisch",
  "Sur Empire": "Persisch (Hof), Hindavi",
  "Swedish Empire": "Schwedisch",
  "Tahirid Sultanate": "Arabisch",
  "Talpur Dynasty": "Sindhi, Persisch",
  "Tây Sơn dynasty": "Vietnamesisch",
  "Tokugawa Shogunate": "Japanisch",
  "Tughlaq Dynasty": "Persisch",
  "Utpala Dynasty": "Sanskrit",
  "Wadai Empire": "Maba, Arabisch",
  "Wattasid dynasty": "Arabisch, Berberisch",
  "Western Chalukya Empire": "Kannada, Sanskrit",
  "Western Karakhanid Khanate": "Karachanidisch (Turksprache)",
  "White Horde": "Kiptschakisch (Turksprache)",
  "Xin Dynasty": "Altchinesisch",
  "Yadava Dynasty": "Marathi, Sanskrit",
  "Yarubid dynasty": "Arabisch",
  "Yuan Dynasty": "Mongolisch, Mittelchinesisch",
  "Zagwe dynasty": "Ge'ez, Amharisch",
  "Zand Dynasty": "Persisch",
  "Zayyanid dynasty": "Arabisch, Berberisch",
  "Zengid dynasty": "Turksprachen, Arabisch",
  "Zirid dynasty": "Arabisch, Berberisch",
  "Ziyadid dynasty": "Arabisch",
  "Ziyarid dynasty": "Persisch",
  "Zurayid dynasty": "Arabisch",
};

export function getEmpireLanguage(name: string): string | null {
  return FALLBACKS[name]?.language ?? LANGUAGE_ONLY[name] ?? null;
}
